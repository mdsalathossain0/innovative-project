  ...
  return (
    <section className='bg-banner w-full bg-no-repeat bg-cover bg-center '>
        <div className='bg-[#6b62c5e6] w-full py-[210px]'>
            ...
            <Subheading className='text-[#ffffffe0] leading-10 w-[715px] mx-auto text-center pb-4' text='A beautiful website passionately crafted for your small business.  Our Digital Agency development has changed the way brands and businesses use technology for growing business. '/>
